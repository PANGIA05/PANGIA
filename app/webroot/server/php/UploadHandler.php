...
class UploadHandler
{
	...
	$sql=mysql_query("insert into galleries (uid,image_name,size) values('$uid','$name','$size')");
            ...
            if ($success) {
                foreach($this->options['image_versions'] as $version => $options) {
                    if (!empty($version)) {
                        ...
                        if (is_file($file)) {
                            unlink($file);
			    $sql=mysql_query("DELETE FROM galleries WHERE image_name = '$file_name'");	
                        }
                    }
                }
