...
//$string  = 'Hi <b>'.$newArr.'</b>,<br/><br/>';
$string .='Hi, Please register to our website for Playing Tournament <a href="'.LIVE_SITE.'/users/register">link</a> and becoming a member with me.';
$string .= '<br/><br/>Thanks!
