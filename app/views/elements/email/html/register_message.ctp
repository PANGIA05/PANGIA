...
$string = 'Hi <b>'.$userDetail['User']['firstname'].'</b>, ';
$string .= 'we just wanted to thank you for joining the GoFundMe platform. Your membership gives you access to a wide range of consultants and businesses to choose from that best suits your needs, among many other great features. We would also like to take this time to remind you that you can refer other business professionals such as yourself and in return get discounts on your future upgrade packages. Click <a href="'.LIVE_SITE.'/users/referBox/'.$enuserid.'">here</a> to learn more.';
$string .= '
