 ...
 function saveEvent(id){
	//alert(id);
	  //var data1 = $('#event'+id+'EventEditForm').closest("form").serialize();
	   ...
	   // alert($("PageDescription"+id).val());
	   // alert(htmlDesc);
	   var img=$("#eventImageName").val();
	   $.ajax({
		  type: 'POST',
    ...
    <body>
<?php // echo "<pre>"; echo print_r($event1); echo "</pre>";?>
		<?php // echo print_r($event2); ?>
		<?php //echo print_r($event3); ?>
	<!--[if lt IE 7]>
       ...
       <div class="s-event-mid02 s-event-mid03">
            <div class="container modal-container">
                <div class="row">
				 <?php
				      $id=$event1['Events']['id'];
					  echo $this->Form->create('event',array('onsubmit' => "return Checkform($id);",'id'=>'createarticle$id'));
				    echo $this->Form->input('image_name', array('type'=>'hidden','value'=>'')); 
				   ?>
                  <div class="col-md-4 left-edit-section">
                     <div class="upload-image">
                      <img src="<?php echo LIVE_SITE;?>/img/upload_image.jpg" id="evntimage" class="evntimage">
                  ...
                  <div class="form-group event-cost">
                    ...
                    <!-- <button type="submit" class="btn btn-default edit-btn-blue">Cancel</button>-->
                     <button type="submit" class="btn btn-default edit-btn-red">Save</button>
                      <a href="#" class="btn btn-default edit-btn-blue">Cancel</a>
                     </div>  
<!--
            ...
            <div class="container modal-container">
                <div class="row">
				 <?php
				      $id=$event2['Events']['id'];
					  echo $this->Form->create('event',array('onsubmit' => "return Checkform($id);",'id'=>"createarticle$id"));
				    echo $this->Form->input('image_name', array('type'=>'hidden','value'=>'','id'=>'evtimg'.$id)); 
				   ?>
                  <div class="col-md-4 left-edit-section">
                     <div class="upload-image">
                      <img src="<?php echo LIVE_SITE;?>/img/upload_image.jpg" id="<?php echo 'evntimage'.$id;?>" class="evntimage">
                      <div class="form-group">
						<?php echo $this->Form->input('event_image',array('id'=>'image','label'=>false,'type'=>'file','class'=>'test','url'=>'http://softprodigy.in/PANGIA/img/event_01.jpg'));  ?>
				     </div>
                     </div>
                     <div class="date-time">
                      <label for="exampleInputFile">Event Date</label>
...
<?php foreach($eventDetails as $value){
       ...
       <div class="s-event-mid02 s-event-mid03">
            <div class="container modal-container">
                <div class="row">
				 <?php
				 $id=$event['id'];
					echo $this->Form->create('event'.$id,array('autocomplete'=>'off', 'class' =>'adminLogin','onsubmit'=>"saveEvent($id);"));		
				    echo $this->Form->input('image_name', array('type'=>'hidden','value'=>'')); 
				    echo $this->Form->input('formid', array('type'=>'hidden','value'=>$event['id'])); 
				   ?>
                    ...
                    <div class="col-md-4 left-edit-section">
                     <div class="upload-image">
                      <img  style="width:100px;height:100px;" src="<?php echo LIVE_SITE;?>/app/webroot/img/upload_userImages/<?php echo $event['event_image']?>" id="evntimage" class="evntimage">
                      <div class="form-group">
						<?php echo $this->Form->input('event_image',array('id'=>'image','label'=>false,'type'=>'file','class'=>'test'));  ?>
				     </div>
                     </div>
                    ...
                    <div class="form-group event-cost">
                    <label for="exampleInputEmail1">Event Cost (for paid event only)</label>
                    <?php echo $this->Form->input('event_cost', array('type'=>'text','label'=>false,'class'=>'form-control','value'=>$event['event_cost'])); ?>
                    <!--<input type="email" class="form-control" id="exampleInputEmail1" placeholder="">-->
                  </div>
                  <div class="form-group event-cost">
                    <label for="exampleInputPassword1">Event Capacity (How many seats)</label>
                    <?php echo $this->Form->input('event_capacity', array('type'=>'text','label'=>false,'class'=>'form-control','value'=>$event['event_capacity'])); ?>
                 
                  </div>
                    <div class="form-group event-cost">
                    <label for="exampleInputPassword1">Title</label>
                    <?php echo $this->Form->input('event_title', array('type'=>'text','label'=>false,'class'=>'form-control','value'=>$event['event_title'])); ?>
                 
                  </div>
                    <div class="form-group event-cost">
                    <label for="exampleInputPassword1">Address</label>
                    <?php echo $this->Form->input('event_address', array('type'=>'text','label'=>false,'class'=>'form-control','value'=>$event['event_address'])); ?>
                    ...
                    <div class="col-md-8 edit-section-right">
						<?php echo $this->Form->input('event_description',array('label'=>false,'id'=>'PageDescription'.$event['id'],'type'=>'textarea','class'=>'form-control','value'=>$event['event_description'],'row'=>'10','cols'=>'80'));
							?>
                              <script>
									CKEDITOR.replace('PageDescription<?php echo $event['id']; ?>' );
							</script> 
							<div class="edit-buttons">
                      <button type="submit" class="btn btn-default edit-btn-red">Save</button>
                      <a href="#" class="btn btn-default edit-btn-blue">Cancel</a>
                ...
                <div class="row">
                   <div class="edit-event-detail">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <img src="http://softprodigy.in/PANGIA/img/event_01.jpg" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
						...
						<img src="http://softprodigy.in/PANGIA/img/event_01.jpg" class="img-responsive test3">
                        </div>
                    </div>
                    <?php if($this->Session->check('Admin')=='true'){
						?>
                  <div class="edit-buttons">
					...
					<?php foreach($eventDetails as $value){
						  foreach($value as $event){
						 ?>
						   <div class="s-event-mid01    pardeep">
            <div class="container">
                <div class="row">
						  <div class="edit-event-detail">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <h5><?php echo $event['event_address'];?></h5>
                     <p><?php echo $event['event_description']?>  </p>
                      </div>
                    
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="m-event-mid02-right">
                         <img class="img-responsive" src="<?php echo LIVE_SITE .'/app/webroot/img/upload_userImages/'.$event['event_image'] ?>" />
                    ...
                    <?php if($this->Session->check('Admin')=='true'){
							...
							?>
                    <div class="edit-buttons">
                     <button type="submit" class="btn btn-default edit-btn-blue" data-toggle="modal" data-target="#myModal<?php echo $event['id']?>">Edit</button>
                     <button type="submit" class="btn btn-default edit-btn-red" data-toggle="modal" data-target="#myModal">Delete</button>
                     </div>
                     <?php }?>
                   <!-- <div class="col-md-4 col-sm-4 col-xs-12">
...
{   
	 ...
	 //  alert(htmlDesc);
	  ...
	  alert(img);
	   // var img='';
	 // var id='';
	 // alert('<?php echo LIVE_SITE;?>/admins/saveEvents');
	   $.ajax({
		  type: 'POST',
		  url:'<?php echo LIVE_SITE;?>/admins/saveEvents',
		  data:data1+'&desc='+htmlDesc+'&img='+img+'&id='+id,
