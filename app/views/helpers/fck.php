...
class FckHelper extends HtmlHelper {
    function load($id,$width=null,$height=null ,$toolbar = 'Getbiz') {
...
fckLoader_$did = function () {
	...
	bFCKeditor_$did.SkinPath = '/editor/skins/office2003/';
...
FCK_CODE;
	...
	$output .= "fck.SkinPath = fck.BasePath + 'editor/skins/office2003/';\n";		
        ...
        $output .= "var sOptions = 'toolbar=yes,status=no,resizable=yes,dependent=yes,scrollbars=yes';\n";
