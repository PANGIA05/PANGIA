...
class gmail extends openinviter_base
	...
	public function login($user,$pass)
		...
		$post_elements=array('accountType'=>'HOSTED_OR_GOOGLE','Email'=>$user,'Passwd'=>$pass,'service'=>'cp','source'=>'OpenInviter-OpenInviter-'.$this->base_version);//pr($post_elements);die;
