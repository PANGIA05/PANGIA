...
class AdminsController extends AppController{
	var $name = "Admins";
	var $uses = array('Admin','User','Articlecategory','Setting','Metatag','Article','Banner','Donation','Category','Question','Commonquestion','Socialsetting','Help','Events','Members','Abouts','Contacts');  
...
$this->redirect(array('controller'=>'admins','action'=>'dashboard'));                       
	...
	function updateMembers(){
	   if(isset($_REQUEST['id'])){
		    ...
		    $data=array();
		    $data['Members']['id']=$id;
			//$data['Members']['description']=htmlentities($_REQUEST['dec']);
			$data['Members']['description']= $_REQUEST['dec'];
			$data['Members']['image']= $_REQUEST['img'];
			$data['Members']['name']=$_REQUEST['data']['member'.$_REQUEST['id']]['name'];
			 print_r($data);
			if($this->Members->save($data)){
				die("Record Saved SuccessFully!");	
			 }else{
					echo "tegete";
			}
	...
	function updateAboutUs(){
	   ...
	   if(isset($_REQUEST['id'])){
		    ...
		    $desc= $_REQUEST['dec'];
		    $data['Abouts']['id']=$id;
			$data['Abouts']['description']= $desc;
			$data['Abouts']['image']= $_REQUEST['img'];
			$data['Abouts']['name']=$_REQUEST['data']['aboutus'.$_REQUEST['id']]['aboutname'];
			 if($this->Abouts->save($data)){
				die("Record Saved SuccessFully!");	
			 }else{
					echo "tegete";
			}
